(function () {
	...
	function sections() {
		...
		if (hasRole("EdgePay Admin", "EdgePay Manager")) items.push({label:"Platform Setup",icon:"settings",items:[{label:"Provider Accounts",icon:"settings",route:"/app/edgepay-provider-account"}]});
		return items;
	}
	function register() {
